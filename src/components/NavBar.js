...
import { TwitterIcon, DribbbleIcon, GithubIcon, LinkedInIcon, PinterestIcon, SunIcon, MoonIcon, PhoneIcon, MailIcon } from "@/components/Icon";
        ...
        <header 
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    ...
                    */}
                    <motion.a href="tel:0819490540" target={"_blank"}
                    whileHover={{y:-2}}
                    whileTap={{scale:0.9}}
                    className="w-6 mr-3">
                        <PhoneIcon />    
                    </motion.a>   
                    <motion.a href="mailto:lvtoan.cv@gmail.com" target={"_blank"}
                    whileHover={{y:-2}}
                    whileTap={{scale:0.9}}
                    className="w-6 mx-3">
                        <MailIcon />    
                    </motion.a>    
                    <motion.a href="https://github.com/LeVanToan-it" target={"_blank"}
                    whileHover={{y:-2}}
                    whileTap={{scale:0.9}}
                    className="w-6 mx-3">
                        <GithubIcon />    
                    </motion.a>    
                    <motion.a href="https://www.linkedin.com/in/toan-lv/" target={"_blank"}
                    whileHover={{y:-2}}
                    whileTap={{scale:0.9}}
